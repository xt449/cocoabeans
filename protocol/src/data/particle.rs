...
impl Particle {
    pub fn get_id(&self) -> i32 {
        return match self {
            ...
            Particle::DustColorTransitionParticle { .. } => {
                ParticleTypeRegistry::dust_color_transition as usize as i32
            }
            Particle::ItemParticle(_) => ParticleTypeRegistry::item as usize as i32,
            Particle::BlockVibrationParticle { .. } => {
                ParticleTypeRegistry::vibration as usize as i32
            }
...
impl MinecraftWritable for Particle {
    fn serialize_to(&self, writer: &mut MinecraftWriter) {
        ...
        match self {
            ...
            Particle::BlockStateParticle(_, blockstate) => writer
                .write_varint(blocks::get_id_from_blockstate(blockstate.deref()) as usize as i32),
